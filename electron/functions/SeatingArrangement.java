...
public class SeatingArrangement {
    ...
    public static void generateSeatingArrangement(Slots slots, Map<String, StudentCourses> studentCoursesMap, int slotIndex, List<Room> rooms, Map<String, List<String>> seatingArrangement){
        ...
        try (BufferedReader brrr = new BufferedReader(new FileReader("./electron/functions/sources/Rooms.txt"))) {
            String line;
    ...
    public static void assignInvigilators(Map<String, List<String>> seatingArrangement, List<Staff> invigilators, List<InvigilatorRoom> invigilatorRooms, int slotIndex, Slots slots) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("./electron/functions/documents/Invigilator_Assignment.tsv", true))) {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader brrr = new BufferedReader(new FileReader("./electron/functions/sources/Invigilators.txt"))) {
            String line;
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("./electron/functions/documents/Invigilator_Assignment.tsv"))) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("./electron/functions/documents/Seating_Arrangement.tsv"))) {
        ...
        for (int i = 0; i < slots.getNumberOfSlots(); i++) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("./electron/functions/documents/Seating_Arrangement.tsv", true))) {
